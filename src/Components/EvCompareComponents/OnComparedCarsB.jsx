...
function OnComparedCarsB() {
    ...
    const handleNavigate = () => {
        ...
        navigate(`/compared-ev-cars/${car1.id}/${car2.id}/${car1.car_name}/${car2.car_name}/${car1.car_model}/${car2.car_model}`);
        ...
        <div className="fixed bottom-4 right-4 z-50">
            {compareCars.length > 0 && (
                <div className="flex gap-4">
                    {compareCars.map((car) => (
                        <div key={car.id} className="relative bg-white p-4 rounded-lg shadow-lg justify-items-center">
                            ...
                            <div className="flex flex-col justify-between items-center">
                                ...
                                <p className='text-[#616b89] text-sm font-normal leading-normal line-clamp-2'>{car.car_model} - {car.car_year}</p>
                                <button
